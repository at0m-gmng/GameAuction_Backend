...
/// <summary>
/// Событие: игрок присоединился к лобби.
/// </summary>
/// <param name="LobbyId">Идентификатор лобби.</param>
/// <param name="PlayerId">Идентификатор игрока.</param>
/// <param name="SlotsTaken">Сколько слотов занято после присоединения.</param>
public sealed record PlayerJoinedLobby(Guid LobbyId, Guid PlayerId, int SlotsTaken) : IDomainEvent
{
