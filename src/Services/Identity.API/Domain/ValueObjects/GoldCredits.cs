...
/// <summary>
/// Неизменяемый объект-значение количества золотых кредитов; не может быть отрицательным.
/// </summary>
public sealed class GoldCredits : ValueObject
{
    ...
    /// <summary>
    /// Возвращает новый объект с уменьшенным количеством кредитов — нельзя потратить больше, чем есть.
    /// </summary>
